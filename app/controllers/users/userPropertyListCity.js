 ...
 */
const userPropertyListCity = async (req, res) => {
    try {
        ...
        const query = property.find({ City: req.body.city , Current_Owner: req.user._id  }).populate('City')
...
module.exports = { userPropertyListCity }
