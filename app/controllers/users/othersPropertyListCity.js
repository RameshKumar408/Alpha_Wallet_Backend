 ...
 */
const othersPropertyListCity = async (req, res) => {
    try {
        // const query = await checkQueryString(req.query)
        // const id = req.user.wadress
        const query = property.find({ Current_Owner: { $ne: req.user._id } , City: req.body.city}).populate('City')
...
module.exports = { othersPropertyListCity }
